...
def isWinner(x, nums):
    ...
    In each round, they take turns picking prime numbers from
    a set of consecutive integers starting from 1 up to n,
    removing the chosen prime and its multiples.
